...
<div class="main-wrapper" id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
    <div class="main-courseview">
        <!-- ============================================================== -->
        <!-- Topbar header - style you can find in pages.scss -->
        <!-- ============================================================== -->
        <header class="topbar topbar-courseview" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    <span>
                        <a href="/blogdetail" class="btn">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    <div class="container-fluid pt-4">
                        <p class="text-navbar">Learn about Adobe XD & Prototyping</p>
                        <div class="row">
                            <div class="col-6 left">
                                <p class="span-navbar">Introduction about XD</p>
                            </div>
        ...
        <div class="page-wrapper section-courseview">
