        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Semua siswa DTC akan muncul disini</h6>
                </div>
                                ...
                                <td style="text-align: center;">
                                    <form class="d-inline" action="" method="GET">
                                        <button type="submit" class="btn btn-success btn-sm mr-1">
                                            <i class="fa-solid fa-pen"></i> Activate
                                        </button>
                                    </form>

                                    <form class="d-inline" action="" method="GET">
                                        <button type="submit" class="btn btn-success btn-sm mr-1">
                                            <i class="fa-solid fa-pen"></i> Deactivate
                                        </button>
                                    </form>
