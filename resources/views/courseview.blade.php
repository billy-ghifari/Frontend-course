    ...
    <header class="topbar" data-navbarbg="skin6">
        <nav class="navbar top-navbar navbar-expand-md">
            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent">
                <div class="container-fluid pt-4" style="height:130px; background-color: #49BBBD;">
                    <h2 style="">Learn about Adobe XD & Prototyping</h2>
                    <div class="row">
                        <div class="col-6">
                            <p>Introduction about XD</p>
                        </div>
                        <div class="col-6">
                            <i class="far fa-clock"><span>1 hour</span></i>
                        </div>
                    </div>
                </div>
            </div>
...
@endsection
<!-- <iframe src="https://youtu.be/GQejHTFwyLo?si=WT0w99t0U59Rwsyi" width="800" height="600"></iframe> -->